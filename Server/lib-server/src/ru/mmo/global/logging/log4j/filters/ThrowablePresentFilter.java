package ru.mmo.global.logging.log4j.filters;
...
public class ThrowablePresentFilter extends Filter
{
	 ...
	 * @return {@link org.apache.log4j.spi.Filter#ACCEPT} if throwable present, {@link org.apache.log4j.spi.Filter#DENY} otherwise
	 */
	@Override
