package ru.mmo.global.logging.log4j.appenders;
...
public class TruncateToZipFileAppender extends FileAppender
{
	 ...
	 */
	private SimpleDateFormat backupDateFormat;

	public TruncateToZipFileAppender()
	{
		//
	}
	...
	protected void truncate(File file)
	{
		...
		if(FileUtils.isFileOlder(file, ManagementFactory.getRuntimeMXBean().getStartTime()))
		{
			...
			String date = backupDateFormat.format(file.lastModified());
	...
	{
		throw new IllegalArgumentException("Can't get as String");
	}
	...
	{
		this.backupDateFormat = new SimpleDateFormat(backupDateFormat);
	}
}