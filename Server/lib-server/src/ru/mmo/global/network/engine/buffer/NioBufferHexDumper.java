...
/**
 * Provides utility methods to dump an {@link NioBuffer} into a hex formatted string.
 * 
 * @author The Apache MINA Project (dev@mina.apache.org)
 */
public class NioBufferHexDumper
{
	...
	/**
	 * Dumps an {@link NioBuffer} to a hex formatted string.
	 * 
	 * @param in
	 *            the buffer to dump
	 * @param lengthLimit
	 *            the limit at which hex dumping will stop
	 * @return a hex formatted string representation of the <i>in</i> {@link Niobuffer}.
	 */
